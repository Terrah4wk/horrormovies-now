...
<<<<<<< HEAD
                        'title'        => html_entity_decode($netflix_new_movies['title'], null, 'UTF-8'),
...
=======
                        ...
                        'released'    => $netflix_new_movies['released'],
                        'runtime'     => $netflix_new_movies['runtime'],
                        'expire_date' => $netflix_new_movies['unogsdate'],
                        'imdbid'      => $netflix_new_movies['imdbid'],
                        'rating'      => round($imdb->rating()),
                        'type'        => $imdb->movietype(),
>>>>>>> 142c02fe9a8decb1ee08c4954ec0ead7a7430371
                    ];
                ...
                foreach ($netflix_movie['ITEMS'] as $netflix_movie) {
                    ...
                    if (isset($genre) && Str::contains($genre, 'Horror')) {
                        ...
                        $insert_data = [
                            ...
                            'title'       => html_entity_decode($netflix_movie['title'], null, 'UTF-8'),
            ...
            foreach ($netflix_expired_movies['ITEMS'] as $netflix_expired_movie) {
                ...
                if (isset($genre) && Str::contains($genre, 'Horror')) {
                    ...
                    $insert_data = [
                        ...
                        'title'       => html_entity_decode($netflix_expired_movie['title'], null, 'UTF-8'),
