...
@section('content')
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Nur noch kurze Zeit auf Netflix</h1>
            @if(empty($movies))
                <p class="lead text-muted">Im Moment gibt es keine auslaufende Horrorfilme.</p>
            @endif
        </div>
    </section>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            Endet: {{ date('d.m.y', strtotime($movie->expire_date)) }}
                                        </li>
                                        <li class="list-group-item">
