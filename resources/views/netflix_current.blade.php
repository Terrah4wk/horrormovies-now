...
@section('content')
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Aktuell auf Netflix</h1>
            @if(empty($movies))
                <p class="lead text-muted">Im Moment gibt es keine Horrorfilme.</p>
            @endif
        </div>
    </section>
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                Veröffentlicht: {{ date('d.m.y', strtotime($movie->date)) }}
                            </li>
                            <li class="list-group-item">
